...
export default function Song() {
    ...
    return (
        <main className='flex flex-col h-full w-full items-center gap-2'>
            {image === undefined || image === "" ? <Image src={SpotifyLogo} priority={true} className='h-1/2 w-1/4 border-tertiary ' alt='SpotifyCover' /> : <img src={image} className='h-1/2 w-2/4 md:w-1/4 border-4 border-tertiary ' />}
